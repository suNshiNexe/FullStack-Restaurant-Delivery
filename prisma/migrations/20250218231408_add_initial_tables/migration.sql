-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'IN_PREPARATION', 'FISNISHED');
...
-- AddForeignKey
ALTER TABLE "Order" ADD CONSTRAINT "Order_restarauntId_fkey" FOREIGN KEY ("restarauntId") REFERENCES "Restaurant"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
